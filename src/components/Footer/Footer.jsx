        ...
        <div className="bg-slate-50">
            <footer className="footer p-10 text-base-content container mx-auto">
                <div>
                    ...
                    <Link to='/' className="link link-hover">Bulk Order</Link>
                    <Link to='/' className="link link-hover">Oversea Delivery</Link>
                    <Link to='/' className="link link-hover">Reliable Hardware</Link>
                
                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <Link to='/' className="link link-hover">Summary</Link>
                    <Link to='/' className="link link-hover">Dashboard</Link>
                    <Link to='/' className="link link-hover">Products</Link>
                    <Link to='/' className="link link-hover">My Profile</Link>
                </div>
                <div>
