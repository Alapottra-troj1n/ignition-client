    ...
    return (
        ...
        <div className="hero min-h-[80vh] bg-base-100">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={background} alt='bg' className="max-w-xs md:max-w-md lg:max-w-xl rounded-lg shadow-2xl" />
                <div className="my-10 lg:my-0">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold"> <span className="text-primary">Best Industrial</span> Quality Hardwares</h1>
