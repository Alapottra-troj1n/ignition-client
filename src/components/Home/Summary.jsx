...
const Summary = () => {
    return (
        <div className='my-20 container mx-auto'>
            <div className='my-10'>
                <h2 className="text-center  font-bold text-3xl lg:text-4xl"> <span className="text-primary">TRUSTED BY </span>THOUSANDS OF BUSINESSES</h2>
                <p className='text-center text-lg text-slate-500'>Our Business Summary</p>
            </div>

            <div className='flex justify-center mb-5'>
                <img src={summarypic} className="max-w-xs md:max-w-md lg:max-w-lg" alt="summary" />
            </div>
                ...
                <div className="stats stats-vertical lg:stats-horizontal shadow">
                    ...
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 text-primary h-8 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
